...
public class Caso_014_Cierre_de_sesion_exitoso_de_la_SV {
	tools tools;
	pageIndex objIndex;
	...
	String _class = "Caso_014_Cierre_de_sesion_exitoso_de_la_SV";
	String _method = "";
	
	String Caso = "Caso_014_Cierre_de_sesion_exitoso_de_la_SV";
	...
	public void cerrarSesion(){
		if (continuar) {			
			try {	
				...
				objMenuCliente.cerrarSesion.click();
				tools.screenshot("scripts", "Caso", "cerrarSesion");
				Thread.sleep(4000);	
			} catch (Exception e) {
				tools.skipScript(e);
			}
