...
public class Caso_011_Descargar_certificado_de_licencias_medicas_pagadas {
	tools tools;
	pageIndex objIndex;
	...
	String _class = "Caso_011_Descargar_certificado_de_licencias_medicas_pagadas";
	String _method = "";
	
	String Caso = "Caso_011_Descargar_certificado_de_licencias_medicas_pagadas";
	...
	public void ingresoCertificadosEInformes(){
		if (continuar) {			
			try {	
				...
				System.out.println("Ingreso a submenu certificados e informes");
	...
	public void descargarLicencias(){
		if (continuar) {			
			try {	
				...
				System.out.println("Descargar Licencias Medicas");
				objCertificadosInformes.btnDescargarLicencias.click();
				tools.screenshot("scripts", "Caso", "descargarLicencias");
				Thread.sleep(4000);
			} catch (Exception e) {
				tools.skipScript(e);
			}
